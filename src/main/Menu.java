	...
	public void update(double elapsedTime) {
		...
		case CHOOSEMAP:
			if (buttons.isEmpty()) {
				...
				buttons.add(new Button(20, 12, Assets.getInstance().getSprite("right_arrow"), new Color(0x84DE02), "") {
				...
				buttons.add(new Button(26, 1, Assets.getInstance().getSprite("book"), Color.white, Assets.getInstance().I18N("changeLanguage")) {

					@Override
					public void buttonPressed() {
						if(Assets.getInstance().getCountry() == "IT")
							Assets.getInstance().loadLang("en");
						else
							Assets.getInstance().loadLang("it");
						
						this.text = Assets.getInstance().I18N("changeLanguage");
					}
				});
			}
